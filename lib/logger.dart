...
class Logger {
  ...
  /// Get show in release mode.
  bool get showInReleaseMode => _showInReleaseMode;

  /// Set show in release mode.
  void setShowInReleaseMode(bool show) => _showInReleaseMode = show;
